<template>
    <Head title="Permission Management"></Head>
    <div class="grid">
        <div class="col-12">
            <div class="card">
                <Toast />
    ...
    methods: {
        loadLazyData() {
            ...
            this.datatableService
                .getData(this.route("permissions.index"), this.lazyParams)
                .then((data) => {
        ...
        onSelectAllChange(event) {
            ...
            if (selectAll) {
                this.datatableService.getData(this.route("permissions.index"),this.lazyParams).then((data) => {
                    this.selectAll = true;
        ...
        saveModel() {
            ...
            if (this.model) {
                if (this.model.id) {
                    axios
                        .put("api/permissions/" + this.model.id, this.model)
                        .then((response) => {
                            this.$toast.add({
                                severity: "success",
                                summary: "Successful",
                ...
                // If empty then add new record
                    ...
                    axios
                        .post("api/permissions", this.model)
                        .then((response) => {
        ...
        deleteModel() {
            axios
                .delete("api/permissions/" + this.model.id)
                .then((response) => {
                    this.$toast.add({
                        severity: "success",
                        summary: "Successful",
